    ...
    <div className="flex flex-col justify-center md:justify-between items-start gap-y-8 md:gap-y-0 w-full md:h-[90vh] min-h-[450px]  md:gap-x-8 hero-section px-5 md:px-[8%] lg:px-[7%] mb-[50px] md:mb-[100px] relative bg-white z-20 pt-12 md:pt-7">
      ...
      <div className="flex flex-col md:flex-row justify-center md:justify-between items-center gap-y-5 md:gap-y-0 w-full h-full">
        ...
        <div className="flex flex-col justify-center items-center md:basis-[60%] w-full h-full relative z-[5]">
          <div className="flex flex-col justify-center items-center md:items-end min-h-[450px] w-full bg-virtual-account-hero bg-contain bg-no-repeat p-0 pb-[calc(100% * 3 / 4)] bg-left md:bg-center z-[8]" />
        </div>
      </div>
    </div>
  );
