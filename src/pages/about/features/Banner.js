...
const Banner = () => {
  return (
    <div className="flex flex-col justify-center md:justify-between items-start gap-y-8 md:gap-y-0 w-full  md:gap-x-8 px-5 md:px-[8%] lg:px-[7%] mb-[50px] md:mb-[100px] relative bg-white z-20 pt-7">
