...
const SectionTwo = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row justify-start md:justify-between items-center bg-pattern_bg_2 sm:bg-none md:bg-blue-50 w-full min-h-[500px] md:gap-x-8 px-5 md:pr-[5%] lg:pr-[8%]">
