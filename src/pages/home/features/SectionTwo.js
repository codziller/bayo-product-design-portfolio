...
const SectionTwo = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row justify-start md:justify-between items-center md:bg-blue-50 w-full min-h-[500px] md:gap-x-8 px-5 md:pr-[5%] lg:pr-[8%]">
      <div className="flex flex-col justify-start items-center md:items-start md:basis-[50%] w-full md:h-full relative bg-pattern_bg_2 bg-center bg-cover bg-no-repeat md:pl-[5%] lg:pl-[8%]">
